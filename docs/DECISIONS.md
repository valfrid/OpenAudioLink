...
- **VBUS.** A host powers its peripheral. A board whose USB-C is wired as
  ...
  **Partly answered, 2026-08-18:** a separate supply to the board settles
  the *current* — 100 mA for the measured dongle is nothing. It does not
  settle whether 5 V reaches the connector's VBUS pin, since device-wired
